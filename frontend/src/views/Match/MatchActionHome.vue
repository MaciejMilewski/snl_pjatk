<template>
  <div class="uk-align-center uk-text-center">
    ...
    <div class="uk-flex-inline">
      <button @click="toggleGoal()" id="przycisk-gol" class="uk-button uk-button-default uk-margin-left ">Gol</button>
      <button @click="togglePenalty()" id="przycisk-kara" class="uk-button uk-button-default  uk-margin-left ">Kara
      </button>
    </div>
    ...
    <!--    Gol  -->
    <div id="gol-gospodarze-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title uk-text-center">{{ teamName }}</h2>
        <button class="uk-modal-close-default" type="button" uk-close></button>

        <!--   Minuty i sekundy     -->
        <label for="minuty-i-sekundy-gospodarze" class="uk-label">Czas (minuty:sekundy)</label>
        <div class="uk-grid" id="minuty-i-sekundy-gospodarze">
          <div class="uk-width-1-3" id="minuty-gospodarze">
            <input
                type="number"
                min="0"
                placeholder="00"
          ...
          <div class="uk-width-1-3" id="sekudny-gospodarze">
            <input
                type="number"
                min="0"
                max="59"
        ...
        <!--   Sytuacja     -->
        <label for="sytuacja-gospodarze" class="uk-label" style="margin-top: 10px">Sytuacja</label>
        <div class="uk-grid" id="sytuacja-gospodarze">
        ...
        <!--Asystent 1-->
        <label for="asystent-1-gospodarze" class="uk-label" style="margin-top: 10px">Asystent 1</label>
        <div class="uk-grid" id="asystent-1-gospodarze">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="asystent-1-gospodarze"
                id="asystent-1-gospodarze"
                :team-id="teamId"
        ...
        <!--Asystent 2-->
        <label for="asystent-2-gospodarze" class="uk-label" style="margin-top: 10px">Asystent 2</label>
        <div class="uk-grid" id="asystent-2-gospodarze">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="asystent-2-gospodarze"
                id="asystent-2-gospodarze"
                :team-id="teamId"
    ...
    <!--  Kara -->
    <div id="kara-gospodarze-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title uk-text-center"> {{ teamName }}</h2>
        <button class="uk-modal-close-default" type="button" uk-close></button>

        <!--   Minuty i sekundy     -->
        <label for="minuty-i-sekundy-gospodarze-kara" class="uk-label">Czas (minuty:sekundy)</label>
        <div class="uk-grid" id="minuty-i-sekundy-gospodarze-kara">
          <div class="uk-width-1-3" id="minuty-gospodarze-kara">
            <input
                type="number"
                min="0"
                placeholder="00"
          ...
          <div class="uk-width-1-3" id="sekudny-gospodarze-kara">
            <input
                type="number"
                min="0"
                max="59"
        ...
        <!--Ukarany-->
        <label for="ukarany-gospodarze-grid" class="uk-label" style="margin-top: 10px;">Ukarany</label>
        <div class="uk-grid" id="ukarany-gospodarze-grid">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="ukarany-gospodarze"
                id="ukarany-gospodarze"
                :team-id="teamId"
        ...
        <!--   Długość kary     -->
        <label for="dlugosc-kary-gospodarze" class="uk-label" style="margin-top: 10px">Długość</label>
        <div class="uk-grid" id="dlugosc-kary-gospodarze">
          <div class="uk-width-1-1">
        ...
        <!--   Rodzaj kary     -->
        <label for="rodzaj-kary-gospodarze" class="uk-label" style="margin-top: 10px">Rodzaj</label>
        <div class="uk-grid" id="rodzaj-kary-gospodarze">
          <div class="uk-width-1-1">
    ...
    <!--    Zmiana bramkarza -->
    <div id="zmiana-bramkarza-gospodarze-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title uk-text-center"> {{ teamName }}</h2>
        <button class="uk-modal-close-default" type="button" uk-close></button>

        <!--   Minuty i sekundy     -->
        <label for="minuty-i-sekundy-gospodarze-zmiana-bramkarza" class="uk-label">Czas (minuty:sekundy)</label>
        <div class="uk-grid" id="minuty-i-sekundy-gospodarze-zmiana-bramkarza">
          <div class="uk-width-1-3" id="minuty-gospodarze-zmiana-bramkarza">
            <input
                type="number"
                min="0"
                placeholder="00"
          ...
          <div class="uk-width-1-3" id="sekudny-gospodarze-zmiana-bramkarza">
            <input
                type="number"
                min="0"
                max="59"
        ...
        <!--Wchodzi-->
        <label for="wchodzi-gospodarze-grid" class="uk-label" style="margin-top: 10px; color: green !important;">
          <span uk-icon="icon: arrow-up"/>Wchodzi (IN)
        </label>
        <div class="uk-grid" id="wchodzi-gospodarze-grid">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="wchodzi-gospodarze"
                id="wchodzi-gospodarze"
                :team-id="teamId"
                v-model="inPlayer"
                :provide-players="true"
                :players="keepers"
        ...
        <!--Schodzi-->
        <label for="schodzi-gospodarze-grid" class="uk-label" style="margin-top: 10px; color: darkred !important;">
          <span uk-icon="icon: arrow-down"/>Schodzi (OUT)
        </label>
        <div class="uk-grid" id="schodzi-gospodarze-grid">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="schodzi-gospodarze"
                id="schodzi-gospodarze"
                :team-id="teamId"
                v-model="outPlayer"
                :provide-players="true"
                :players="keepers"
    ...
    <!--    Czas dla drużyny -->
    <div id="czas-gospodarze-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title uk-text-center"> {{ teamName }}</h2>
        <button class="uk-modal-close-default" type="button" uk-close></button>

        <!--   Minuty i sekundy     -->
        <label for="minuty-i-sekundy-gospodarze-czas" class="uk-label">Czas (minuty:sekundy)</label>
        <div class="uk-grid" id="minuty-i-sekundy-gospodarze-czas">
          <div class="uk-width-1-3" id="minuty-gospodarze-czas">
            <input
                type="number"
                min="0"
                placeholder="00"
          ...
          <div class="uk-width-1-3" id="sekudny-gospodarze-czas">
            <input
                type="number"
                min="0"
                max="59"
    ...
    <div id="rzut-karny-gospodarze-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title uk-text-center"> {{ teamName }}</h2>
        <button class="uk-modal-close-default" type="button" uk-close></button>

        <!--   Minuty i sekundy     -->
        <label for="minuty-i-sekundy-gospodarze-rzut-karny" class="uk-label">Czas (minuty:sekundy)</label>
        <div class="uk-grid" id="minuty-i-sekundy-gospodarze-rzut-karny">
          <div class="uk-width-1-3" id="minuty-gospodarze-rzut-karny">
            <input
                type="number"
                min="0"
                placeholder="00"
          ...
          <div class="uk-width-1-3" id="sekudny-gospodarze-rzut-karny">
            <input
                type="number"
                min="0"
                max="59"
        ...
        <!--Strzelec-->
        <label for="strzelec-gospodarze-rzut-karny" class="uk-label" style="margin-top: 10px">Strzelec</label>
        <div class="uk-grid" id="strzelec-gospodarze-rzut-karny">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="strzelec-gospodarze-rzut-karny"
                id="strzelec-gospodarze-rzut-karny"
                :team-id="teamId"
        ...
        <!--Bramkarz-->
        <label for="bramkarz-gospodarze-rzut-karny" class="uk-label" style="margin-top: 10px">Bramkarz</label>
        <div class="uk-grid" id="bramkarz-gospodarze-rzut-karny">
          <div class="uk-width-1-1">
            <SquadMultiSelect
                ref="bramkarz-gospodarze-rzut-karny"
                id="bramkarz-gospodarze-rzut-karny"
                :team-id="enemyTeamId"
...
export default {
  ...
  methods: {
    ...
    toggleTeamTime() {
      const modal = UIkit.modal("#czas-gospodarze-modal")
      modal.toggle();
    },
    toggleChange() {
      const modal = UIkit.modal("#zmiana-bramkarza-gospodarze-modal")
      modal.toggle();
    },
    toggleGoal() {
      const modal = UIkit.modal("#gol-gospodarze-modal")
      modal.toggle();
    },
    togglePenalty() {
      const modal = UIkit.modal("#kara-gospodarze-modal")
      modal.toggle();
    },
    togglePenaltyShot() {
      const modal = UIkit.modal("#rzut-karny-gospodarze-modal")
      modal.toggle();
    }
  }
}
